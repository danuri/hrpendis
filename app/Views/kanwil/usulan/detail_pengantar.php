...
<div class="row">
  <div class="col-lg-12">
    ...
    <div class="row mb-3">
        ...
        <div class="col-lg-9">
        <input type="text" class="form-control" id="kab_pengantar_nama" name="prov_pengantar_nama" value="<?= $usulan->prov_pengantar_nama?>">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-lg-3">
        ...
        <div class="col-lg-9">
            <input type="text" class="form-control" id="kab_pengantar_jabatan" name="prov_pengantar_jabatan" value="<?= $usulan->prov_pengantar_jabatan?>">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-lg-3">
