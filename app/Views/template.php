            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-pages">Kepegawaian</span></li>

                        <?php if(session('level') == 4){ ?>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?= site_url('usulan/create')?>">
                                <i class="ri-honour-line"></i> <span data-key="t-widgets">Buat Usulan</span>
                            </a>
                        </li>
                        <?php }?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?= site_url('usulan')?>">
                                <i class="ri-honour-line"></i> <span data-key="t-widgets">Usulan</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?= site_url('download')?>">
                                <i class="ri-honour-line"></i> <span data-key="t-widgets">Download</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="main-content">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © Layanan DitjenPendis.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by DitjenPendis
                            </div>
                        </div>
                    </div>
                </div>
